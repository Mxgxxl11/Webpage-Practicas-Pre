...
$id_escuela_telecomunicaciones = 3; // Cambia este valor según el id real de "Telecomunicaciones" en tu base de datos
...
<body>
    ...
    <div class="container">
        ...
        <article class="table-widget">
            <div class="caption">
                <h2>
                    TODOS LOS ALUMNOS REGISTRADOS DE MECATRONICA    
                </h2>
            </div>
