...
if ($informe4['error'] === UPLOAD_ERR_OK) {
    ...
    $ruta_destino = $ruta_carpeta . "/Constancia_Culminacion.pdf";

    // Mover el archivo a la carpeta correspondiente
    if (move_uploaded_file($informe4['tmp_name'], $ruta_destino)) {
...
$tipo_notificacion = 'Constancia culminación';
$mensaje = 'Subí la constancia de culminación';
