...
<head>
    ...
    <title>Carpetas Electrónica - Administrador</title>
    ...
    <div class="container">
        <main class="main-content">
            ...
            <div class="page-header">
                <h1>⚡ Carpetas Virtuales - Electrónica</h1>
                <span class="school-badge">Escuela Profesional de Ingeniería Electrónica</span>
            </div>
            ...
            <div class="action-buttons">
                <a href="carpetas_electronica.php" class="btn-show-all">📋 Mostrar Todos</a>
                <a href="assets/controladores/reporte_electronica.php" target="_blank" class="btn-download">📥 Descargar Informe</a>
            </div>
                ...
                <table>
                    ...
                    if (isset($_POST['enviar'])) {
                        ...
                        if (empty($codigo) and empty($nombre)) { // si no funciona codigo cambiar a $_POST['codigo']
                            ...
                            window.location = "./carpetas_electronica.php"; 
                            </script>';
                        } else {
                            if (empty($nombre)) {
                                ...
                                WHERE e.id_escuela = 4 and u.codigo like '%" . $codigo . "%'";
                            }
                            if (empty($codigo)) {
                                $busqueda = "SELECT u.codigo, u.nombre1, u.apellido1, u.correo, e.escuela, al.semestre, al.seccion, car.nombre_carpeta, p.paso 
                                FROM usuario u 
                                ...
                                JOIN carpeta_virtual car ON car.id_alumno = al.id_alumno 
                                JOIN paso_cp p ON p.id_usuario = u.codigo 
                                WHERE e.id_escuela = 4 AND (u.nombre1 LIKE '%" . $nombre . "%' 
                    ...
                    ?>
                        ...
                        //aca para mostrar todos los registros de los alumnos de electrónica
                        ...
                        JOIN carpeta_virtual car ON car.id_alumno = al.id_alumno 
                        JOIN paso_cp p ON p.id_usuario = u.codigo 
                        WHERE a.id_rol=3 and e.id_escuela=4;";
