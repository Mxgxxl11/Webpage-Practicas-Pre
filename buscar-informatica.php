...
// Definir el id_escuela de "Telecomunicaciones"
$id_escuela_telecomunicaciones = 1; // Cambia este valor según el id real de "Telecomunicaciones" en tu base de datos
...
<body>
    ...
    <div class="container">
        ...
        <article class="table-widget">
            <div class="caption">
                <h2>
                    TODOS LOS ALUMNOS REGISTRADOS DE INFORMATICA
                </h2>
            </div>
