...
<head>
    ...
    <title>Carpetas Mecatrónica - Administrador</title>
    ...
    <div class="container">
        <main class="main-content">
            ...
            <div class="page-header">
                <h1>⚙️ Carpetas Virtuales - Mecatrónica</h1>
                <span class="school-badge">Escuela Profesional de Ingeniería Mecatrónica</span>
            </div>
            ...
            <div class="action-buttons">
                <a href="carpetas_mecatronica.php" class="btn-show-all">📋 Mostrar Todos</a>
                <a href="assets/controladores/reporte_meca.php" target="_blank" class="btn-download">📥 Descargar Informe</a>
            </div>
